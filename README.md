...
the target. One exact non-isoparametric intersection joining any two distinct
rectangle sides is also supported. Straight parameter paths work on arbitrary
