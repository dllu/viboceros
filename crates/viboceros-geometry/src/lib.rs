...
pub use mesh::{
    ...
    MAX_MESH_SPHERE_FACES, MeshCapFaceStyle, MeshConeOptions, MeshCylinderOptions, MeshEdgeFilter,
    MeshFace, MeshFaceExtraction, MeshHoleFill, MeshTopology, MeshUvSphereOptions, TriangleMesh,
};
