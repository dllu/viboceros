...
fn straight_intersection_snaps_replay_owned_rhino_picks() {
    for (fixture, observed) in [
        ...
        (
            include_str!(
                "../../../../tools/rhino_oracle/fixtures/intersection_nurbs_conic_snaps.json"
            ),
            include_str!(
                "../../../../tools/rhino_oracle/observations/intersection_nurbs_conic_snaps.json"
            ),
        ),
        (
            include_str!(
                "../../../../tools/rhino_oracle/fixtures/intersection_nurbs_arc_snaps.json"
            ),
            include_str!(
                "../../../../tools/rhino_oracle/observations/intersection_nurbs_arc_snaps.json"
            ),
        ),
        (
            include_str!(
                "../../../../tools/rhino_oracle/fixtures/intersection_nurbs_conic_rational_snaps.json"
            ),
            include_str!(
        ...
        (
            include_str!(
                "../../../../tools/rhino_oracle/fixtures/intersection_nurbs_self_snaps.json"
            ),
            include_str!(
                "../../../../tools/rhino_oracle/observations/intersection_nurbs_self_snaps.json"
            ),
        ),
    ] {
...
#[test]
fn multi_source_intersections_replay_owned_rhino_picks() {
    let mut verified = 0;
    for (input, observed) in [
        ...
        (
            include_str!(
                "../../../../tools/rhino_oracle/fixtures/intersection_vertical_sweep_snaps.json"
            ),
            include_str!(
                "../../../../tools/rhino_oracle/observations/intersection_vertical_sweep_snaps.json"
            ),
        ),
        (
            include_str!(
                "../../../../tools/rhino_oracle/fixtures/intersection_rotated_priority_snaps.json"
            ),
            include_str!(
