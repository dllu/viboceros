...
mod tests {
    ...
    fn python_oracle_reports_torus_cylinder_topology() {
        ...
        let expected = [
            ...
            ("centered_perpendicular_turning_loops", 2, 0, Some(3), true),
            (
                "centered_perpendicular_inner_rim_crossing",
                2,
                0,
                Some(3),
                true,
            ...
            (
                "centered_perpendicular_inner_rim_arcs",
                4,
                0,
                Some(3),
                false,
            ...
            (
                "fat_ring_perpendicular_inner_rim_crossing",
                4,
                0,
                Some(3),
                true,
            ...
            (
                "fat_ring_perpendicular_inner_rim_arcs",
                4,
                0,
                Some(3),
                false,
            ...
            (
                "fat_ring_perpendicular_tube_radius_crossing",
                2,
                0,
                Some(3),
                true,
            ...
            (
                "fat_ring_perpendicular_tube_radius_arcs",
                4,
                0,
                Some(3),
                false,
