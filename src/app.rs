...
impl VibocerosApp {
    ...
    fn show_toolbar(&mut self, root: &mut egui::Ui) {
        ...
        let mut weld_vertices_clicked = false;
        ...
        let mut duplicate_mesh_edge_clicked = false;
        ...
        egui::Panel::top("toolbar").show(root, |ui| {
            ui.horizontal_wrapped(|ui| {
                ...
                weld_edge_clicked = ui
                    ...
                    .clicked();
                weld_vertices_clicked = ui
                    .add_enabled(selected > 0, egui::Button::new("Weld Vertices"))
                    .on_hover_text(
                        "Pick a selected-mesh topology vertex to weld its incident seams",
                    )
                    .clicked();
                unweld_clicked = ui
                ...
                unweld_edge_clicked = ui
                    ...
                    .clicked();
                unweld_vertex_clicked = ui
                    .add_enabled(selected > 0, egui::Button::new("Unweld Vertex"))
                    .on_hover_text("Pick a selected-mesh topology vertex to separate by face")
                    .clicked();
                ...
                extract_control_polygon_clicked = ui
                    ...
                    .clicked();
                extract_surface_clicked = ui
                    .add_enabled(selected > 0, egui::Button::new("Extract Surface"))
                    .on_hover_text("Pick a selected NURBS surface or B-rep face to extract")
                    .clicked();
                ...
                duplicate_edge_clicked = ui
                    ...
                    .clicked();
                duplicate_mesh_edge_clicked = ui
                    .add_enabled(selected > 0, egui::Button::new("Dup Mesh Edge"))
                    .on_hover_text("Pick a logical edge on a selected mesh to duplicate")
                    .clicked();
        ...
        } else if weld_vertices_clicked {
            self.try_start_interactive_command("WeldVertices");
        ...
        } else if unweld_vertex_clicked {
            self.try_start_interactive_command("UnweldVertex");
        ...
        } else if delete_faces_clicked {
            self.try_start_interactive_command("DeleteFaces");
        ...
        } else if extract_surface_clicked {
        ...
        } else if duplicate_mesh_edge_clicked {
            self.try_start_interactive_command("DupMeshEdge");
