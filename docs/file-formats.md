...
remain unsupported.
Planar-basis `PCURVE` edge geometry lifts exactly to 3D NURBS while retaining
degree, knots, and rational weights. Other p-curve bases still need exact
surface-curve composition.
