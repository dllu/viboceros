...
its equivalent compact analytic representation. No eligible selection is an error.

`DeleteInputObjects=No` creates unselected copies with the source's attributes,
...
ordering. Tests exhaust all subsets of eight objects and compose ordering with
